<template>
  ...
  >
    <div
      class="relative bg-black/70 text-white rounded-lg w-[190px] min-h-[60px] p-2 pr-3 flex flex-row gap-2"
    >
      <!-- Chevron (Ok) -->
      ...
      <div class="flex flex-col flex-1 items-start justify-start gap-1">
        <!-- Tarih -->
        <div
          class="text-center text-[12px] pl-1 font-semibold tracking-wide leading-tight"
        >
