<template>
  <div class="min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">
              Search results for "<span class="text-yellow-600">{{
                query
              }}</span
              >"
            </h1>
          ...
          <div
            ...
            class="text-sm text-gray-500 bg-white px-3 py-1 rounded-full border border-gray-200 self-start sm:self-auto"
          >
      ...
      <!-- Filters Section -->
      <div class="mb-6 p-4 sm:p-5 rounded-xl shadow-sm border border-gray-200">
        <div
          class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4"
        >
          <div class="w-full">
            <h2 class="text-base sm:text-lg font-semibold text-gray-700 mb-2">
              Filter by
            </h2>
      ...
      <div class="rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <!-- Results Header -->
        <div
          class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gray-50"
        >
          <div
          ...
          >
            <h2 class="text-lg sm:text-xl font-semibold flex items-center">
              <span
                class="w-1.5 h-5 sm:h-6 bg-yellow-600 mr-2 sm:mr-3 rounded-full"
              ></span>
              {{ filter }} Results
            </h2>
        ...
        <div v-if="isLoading" class="p-8 sm:p-12 text-center">
          <div class="inline-flex flex-col items-center">
            <div
              class="animate-spin rounded-full h-8 w-8 sm:h-10 sm:w-10 border-t-2 border-b-2 border-yellow-600 mb-3 sm:mb-4"
            ></div>
        ...
        <div v-else-if="results.length === 0" class="p-8 sm:p-12 text-center">
          <div class="inline-flex flex-col items-center max-w-md mx-auto">
            <svg
              ...
              class="h-12 w-12 sm:h-16 sm:w-16 text-gray-400 mb-3 sm:mb-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <h3
              class="text-lg sm:text-xl font-medium text-gray-700 mb-1 sm:mb-2"
            >
              No results found
            </h3>
            ...
            <button
              class="px-3 py-1.5 sm:px-4 sm:py-2 bg-yellow-600 text-white rounded-lg text-xs sm:text-sm font-medium hover:bg-yellow-700 transition-colors"
              @click="$router.back()"
            >
              Go Back
            </button>
              ...
              <div class="flex gap-3 sm:gap-5">
                ...
                <div class="flex-shrink-0 relative">
                  ...
                  <div
                    ...
                    class="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 bg-yellow-600 text-white text-[10px] sm:text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full shadow-sm"
                  >
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-start justify-between">
                    <div>
                      <h3
                        class="text-base sm:text-lg font-semibold text-gray-800 hover:text-yellow-600 transition-colors line-clamp-1"
                      >
                        {{ item.title || item.name }}
                      </h3>
                      <div
                        class="mt-1 flex flex-wrap items-center gap-x-2 sm:gap-x-4 gap-y-1 text-xs sm:text-sm text-gray-500"
                      >
                        <span>
                          {{
                            item.release_date
                        ...
                        <span class="flex items-center">
                          <span
                            ...
                            class="inline-flex items-center px-2 py-0.5 rounded-full bg-blue-100 text-blue-800 text-[10px] sm:text-xs font-medium"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 mr-0.5 sm:mr-1"
                              viewBox="0 0 20 20"
                              fill="currentColor"
                            >
                              <path
                          ...
                          <span
                            ...
                            class="inline-flex items-center px-2 py-0.5 rounded-full bg-purple-100 text-purple-800 text-[10px] sm:text-xs font-medium"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 mr-0.5 sm:mr-1"
                            ...
                            >
                              <path
                                fill-rule="evenodd"
                                d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm3 2h6v4H7V5zm8 8v2h1v-2h-1zm-2-8h1V5h-1v2zm2 4h1V9h-1v2zm-2 4h1v-2h-1v2zm-2 0h1v-2h-1v2zm-2 0h1v-2H9v2zm-2 0h1v-2H7v2z"
                                clip-rule="evenodd"
                              />
                            </svg>
                            Movie
                  ...
                  <p
                    v-if="item.overview"
                    class="mt-2 text-xs sm:text-sm text-gray-600 line-clamp-2"
                  >
                    {{ item.overview }}
                  </p>
                </div>
        ...
        >
          ...
          >
            ...
            <div
              class="flex items-center gap-1 sm:gap-2 order-1 sm:order-2 w-full sm:w-auto justify-between sm:justify-normal"
            >
              <button
              ...
              >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-3.5 w-3.5 sm:h-4 sm:w-4 ml-1"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
